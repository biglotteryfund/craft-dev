...
class Images
{
    private static function _getImgixConfig()
    {
        ...
        $imgixDomain = $config->getConfig('CUSTOM_IMGIX_DOMAIN', $_ENV['CUSTOM_IMGIX_DOMAIN']);
        $imgixSignKey = $config->getConfig('CUSTOM_IMGIX_SIGN_KEY', $_ENV['CUSTOM_IMGIX_SIGN_KEY']);
